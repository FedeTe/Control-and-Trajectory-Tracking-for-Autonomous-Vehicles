        ...
        if (s != "") {
          ...
          **/
          ...
          for (int i = 0; i < x_points.size(); ++i) {
                ...
                distance = std::hypot(x_points[i] - x_position,
                                      y_points[i] - y_position);
          ...
          cout << "closest_point_idx: " << closest_point_idx
               << " x_position: " << x_position
               << " x_points[closest_point_idx]: "
               << x_points[closest_point_idx] << endl;

          // Error is the angle difference between the actual steer and the
          // desired steer
          double yaw_desired = angle_between_points(
              x_position, y_position, x_points[closest_point_idx],
